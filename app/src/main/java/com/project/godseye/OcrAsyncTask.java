...
public class OcrAsyncTask extends CAsyncTask<Uri, Void, String[]> {
    private static final String TAG = com.example.controller.app.OcrAsyncTask.class.getSimpleName();
    ...
    protected String[] doInBackground(Uri... uris) {
        try {
            boolean multi = new com.example.controller.app.PreferenceManager(contextRef.get()).getMulticolumn();
